...
export const REPORT_DEFINITIONS: ReportDefinition[] = [
  {
    id: "fleet",
    title: "Автопарк",
    description: "Машины и прицепы: пробег, статус, прошедшее и плановое ТО",
    columns: [
      { key: "kind", label: "Тип" },
      ...
      { key: "lastService", label: "Прошедшее ТО" },
      { key: "lastServiceKm", label: "Пробег прошедшего ТО", align: "right" },
      { key: "lastServiceNote", label: "Описание прошедшего ТО" },
      { key: "nextService", label: "Плановое ТО" },
      { key: "nextServiceKm", label: "Пробег планового ТО", align: "right" },
      { key: "nextServiceNote", label: "Описание планового ТО" },
...
export function buildFleetReport(
  ...
  const rows: ReportRow[] = [
    ...vehicles.map((v) => ({
      ...
      lastServiceKm: v.lastServiceOdometer ? `${v.lastServiceOdometer} км` : "—",
      lastServiceNote: v.lastServiceNote || "—",
      nextService: v.nextService,
      nextServiceKm: v.nextServiceOdometer ? `${v.nextServiceOdometer} км` : "—",
      nextServiceNote: v.nextServiceNote || "—",
